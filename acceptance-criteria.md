...
- 1. 3D item should be a pink/red version of the orbital laser item. should mimic all user animations (hold item, press item, toss item after use) from orbital laser
- 2. 2D item icon is a golf ball with pink arrows
- 3. During item use, the orbital laser should sound.
- 4. During item use, the custom audio "bomboclat.mp3" should play as the balls are switched
